...
export const analytics = {
  ...
  apps: (appId: string) => ({
     ...
     */
    performance: createPaginatedApi<PerformanceStat, PerformanceStatsPayload>(`/analytics/apps/${appId}/performance`),
    /**
     * Fetches a paginated list of error trends.
     */
    errors: createPaginatedApi<ErrorTrend, ErrorTrendsPayload>(`/analytics/apps/${appId}/errors`),
    /**
     * Fetches a paginated list of logs.
     */
    logs: createPaginatedApi<LogStat, LogStatsPayload>(`/analytics/apps/${appId}/logs`),
  }),
};
